...
class TestDatabase {
  static final books = [
    ...
    Book(
      ...
      series: 'Harry Potter',
      author: 'J. K. Rowling',
      dateLastEdition: DateTime.utc(2021, 1, 23),
      dateAdded: DateTime.utc(2021, 1, 23),
      genre: Genres.urbanFantasy,
      readingState: ReadingStates.planning,
    ),
    Book(
    ...
    Book(
      ...
      series: '',
      author: 'Stephen King',
      dateLastEdition: DateTime.utc(2021, 2, 14),
      dateAdded: DateTime.utc(2021, 2, 14),
      genre: Genres.horror,
      readingState: ReadingStates.ended,
    ),
    Book(
      id: '2321fgh12',
      title: 'Historia Jana Zamoyskiego',
      series: '',
      author: 'Jan Kowalski',
      dateLastEdition: DateTime.utc(2021, 3, 3),
      dateAdded: DateTime.utc(2021, 3, 3),
      genre: Genres.historicalNovel,
      readingState: ReadingStates.ended,
    ),
    Book(
      id: '2321fgh1231',
      title: 'Historia Jana Potomaka',
      series: 'Królestwo Bożej Opoki w Polsce',
      author: 'Jan Kowalski',
      dateLastEdition: DateTime.utc(2021, 3, 4),
      dateAdded: DateTime.utc(2021, 3, 4),
      genre: Genres.historicalNovel,
      readingState: ReadingStates.planning,
    ),
    Book(
      id: '2321fgh1253',
      title: 'Wrzechświat i Życie',
      series: '',
      author: 'Izabella Strączkiewicz',
      dateLastEdition: DateTime.utc(2021, 3, 4),
      dateAdded: DateTime.utc(2021, 3, 4),
      genre: Genres.popularScience,
      readingState: ReadingStates.ended,
    ),
    Book(
      id: '2321fgh1233',
      title: 'Całość Wszechwiedzy',
      series: '',
      author: 'Izabella Strączkiewicz',
      dateLastEdition: DateTime.utc(2021, 2, 7),
      dateAdded: DateTime.utc(2021, 2, 7),
